...
@section('content')
    ...
    <div class="table-responsive" id="no-more-tables">
        <table class="table table-borderless" width="100%" cellspacing="0">
            ...
            <tbody>
                @foreach ($componentesanyo as $key => $componentes)
                    <tr>
                        <td colspan="8" class="fw-bolder text-center" data-title="Año">
                            Año {{ $anyos[$key] }} 
                        </td>
                    </tr>
                        ...
                        <tr>
                            ...
                            @if (str_contains($componente->nombre, 'Ciclo') || str_contains($componente->nombre, 'Curso'))
                                <th colspan="8" data-title="Componente"
                                    class="text-uppercase bg-secondary bg-opacity-10 small fw-bolder">
