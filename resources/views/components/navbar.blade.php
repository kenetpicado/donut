        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item mx-2 {{ request()->is('rango*') ? 'border-2 border-bottom border-primary' : '' }}">
                    <a class="nav-link" aria-current="page" href="{{ route('range') }}">Rango</a>
                </li>
                <li class="nav-item mx-2 {{ request()->is('terms*') ? 'border-2 border-bottom border-primary' : '' }}">
                    <a class="nav-link" aria-current="page" href="{{ route('terms') }}">Términos</a>
                </li>
            </ul>
        </div>
    </div>
